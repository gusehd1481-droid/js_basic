...
const mBg = document.querySelector('header .m_bg')
const mBgClose = mBg.querySelector('.top .close');
...
const mLoginCart = mBg.querySelector('.login_cart'); //복제 받을 위치
const dLoginCart = document.querySelectorAll('.right_menu .login_cart a'); // 복제 전 선택 = 복제 대상이 누군지 잡기
...
function mLnbHide(){ //하나를 누르면 나머지 숨기기 X , 다 안보이게하고 선택한 것만 보이게 하기
